<?php
    ...
    $to         = 'billiaumaxim@gmail.com';  // put your email here
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        $result = array( 'response' => 'success', 'message'=>'<strong>Bedankt!</strong>&nbsp; De e-mail is verzonden!.' );
    } else {
        $result = array( 'response' => 'error', 'message'=>'<strong>Foutje!</strong>&nbsp; Kan e-mail niet verzenden.'  );
    }
